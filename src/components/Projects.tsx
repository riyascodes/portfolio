...
const projects: Project[] = [
  {
    id: 1,
    title: 'Booksky – Book Management System',
    description: 'A responsive book management system built using pure JavaScript with CRUD operations and real-time search.',
    category: 'Frontend',
    image: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=600&h=400&fit=crop',
    tech: ['HTML', 'CSS', 'JavaScript', 'LocalStorage'],
    github: 'https://github.com/riyascodes/booksky',
    live: 'https://bookmanagementsystem-riyascodes.vercel.app/',      
    problem: 'Managing personal book records manually is inefficient and lacks search and persistence.',
    solution: 'Built a lightweight frontend app using vanilla JavaScript with localStorage to store data and real-time search for better usability.',
    impact: 'Improved understanding of CRUD operations, DOM manipulation, array methods, and client-side data persistence.',
  },
  // {
  //   id: 1,
